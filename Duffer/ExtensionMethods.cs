...
namespace Duffer
{
   ...
   {
      public static string ToIDTFStringRGBA(this System.Drawing.Color color)
      {
      ...
      public static string ToIDTFStringRGB(this System.Drawing.Color color)
      {
          ///Convert the colors from 0-255 to 0-1.0 and 6 dec places
          ///
      ...
      // This got too difficult to do as ExtensionMethods methods, once multiple
       // List<T> constrains were introduced
       //Instead that are statics on the ListExtension class
